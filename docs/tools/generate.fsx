...
let info =
  [ "project-name", "Paket.VisualStudio"
    "project-author", "Igal Tabachnik"
    "project-summary", "A Visual Studio addin for Paket"
    "project-github", githubLink
    "project-nuget", "http://nuget.com/packages/Paket.Core" ]
